...
class HELMAdapter(BaseEvaluationAdapter):
    """Adapter for HELM evaluation outputs. Extracts all metrics and instance-level data."""
    ...
    def transform_from_directory(self, dir_path: str, output_path: str, metadata_args: Dict[str, Any]):
        """Transform HELM results into aggregate EvaluationLogs."""
    ...
    def _extract_generation_args(
        ...
        """Extract generation arguments from HELM adapter spec and request state."""
